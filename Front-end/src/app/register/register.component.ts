...
export class RegisterComponent implements OnInit {
  ...
  registerForm = new FormGroup({
    firstName: new FormControl(null, [Validators.required, Validators.minLength(3), Validators.pattern('^[a-z]{3,15}$'), Validators.maxLength(20)]), //inside the constructor is like a place holder
